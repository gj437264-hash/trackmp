    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4 py-10 animate-fade-slide-up relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="soft-card p-8">
          <div className="soft-label mb-0">/// Access Console</div>
          ...
          <div className="mt-6 flex items-center gap-3">
            ...
            <div className="soft-label mb-0 whitespace-nowrap">Or continue with</div>
            <div className="flex-1 h-px bg-slate-200" />
          </div>
                ...
                <Tooltip key={s.id}>
                  <TooltipTrigger asChild>
                    <button
                      ...
                      disabled
                      className="border border-slate-200 rounded-2xl h-12 grid place-items-center opacity-50 cursor-not-allowed grayscale bg-white"
                      aria-label={`Sign in with ${s.label} — coming soon`}
                    >
                      {s.svg}
                    </button>
                  </TooltipTrigger>
                  <TooltipContent side="bottom" className="rounded-xl bg-slate-800 text-white font-bold uppercase text-xs">
                    {s.label} — Coming Soon
                  </TooltipContent>
                </Tooltip>
              ))}
          ...
          <div className="mt-6 pt-6 border-t border-slate-200 flex items-center justify-between text-sm">
            <Link to="/forgot-password" className="font-bold uppercase text-xs tracking-wider text-slate-500 hover:text-emerald-600 transition-colors" data-testid="forgot-password-link">
              Forgot Password?
            </Link>
            <Link to="/signup" className="font-bold uppercase text-xs tracking-wider text-slate-500 hover:text-emerald-600 transition-colors" data-testid="signup-link">
              Request Access →
            </Link>
          </div>
        </div>
